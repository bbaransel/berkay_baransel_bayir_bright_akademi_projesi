...
const Hero = () => {
    return (
        <>
            <Container fluid className='pt-5 d-flex justify-content-center align-items-center hero'>
                ...
                <Card className='p-5 border-0 hero text-light mb-0'>
                    {/* style={{ width: '50rem' }} */}
                    <Card.Body className='d-flex flex-column justify-content-center align-items-center text-center'>
                        ...
                        <ButtonGroup className='d-flex justify-content-around w-50 mt-5'>
